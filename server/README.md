...
The Proptonomy public-form handler must assign the new contact to the form's
organization. Without that fix, the database rejects submissions with a foreign
key error and the gateway returns a retryable failure.
